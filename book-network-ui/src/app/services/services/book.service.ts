...
export class BookService extends BaseService {
  ...
  static readonly SaveBookPath = '/books/save-book';
  ...
  static readonly ApproveReturnBorrowBookPath = '/books/borrow/return/approva/{book-id}';
  ...
  static readonly FindBookByIdPath = '/books/findbook-byid/{book-id}';
  ...
  static readonly FindAllReturnedBooksPath = '/books/findall-returned-books';
  ...
  static readonly FindAllBooksPath = '/books/findall-books';
  ...
  static readonly FindAllBooksByOwnerPath = '/books/findall-books-by-owner';
  ...
  static readonly FindAllBorrowedBooksPath = '/books/findall-book-borrowed-books';
